...
export const monthlyReports = [
  {
    ...
    summary: {
      budget: '예산 집행률 93.3%',
      research: '논문 52편, 특허 출원 4건',
      employment: '겨울 채용 박람회 참여 124명',
      community: '평생교육 프로그램 8개 운영',
    },
  ...
  },
  {
    ...
    summary: {
      budget: '예산 집행률 95.2%',
      research: '논문 48편, 특허 등록 3건',
      employment: '취업률 통계 조사 완료',
      community: '송년 문화행사 1,200명 참여',
    },
    downloadUrl: '/reports/monthly/2023-12.pdf',
    views: 3124,
  },
]
...
export const townhallMeetings = [
  ...
  },
  {
    ...
    date: '2023-12-21',
    location: '대학본부 대강당 + 온라인 생중계',
    agenda: ['2023년 연간 성과 발표', '2024년 운영 계획', '시민 질의응답'],
    status: 'completed',
    participants: 542,
...
export const annualReports = [
  {
    ...
    highlights: [
      ...
      '취업률 78.5% 달성 (전국 국립대 평균 74.2%)',
      '지역 경제 기여 128억원',
      '탄소배출 12.3% 감축',
    ],
    taxpayerROI: '1원당 2.37원의 가치 창출',
...
export const timelineData = [
  {
    ...
    category: 'budget',
    type: 'milestone',
    title: '1분기 예산 집행률 93.3% 달성',
    description: '첨단 실험장비 구입(3.5억원), 학생 장학금 지급(2.5억원) 등 주요 사업 정상 집행',
    icon: '💰',
    color: '#2563eb',
    importance: 'high',
  },
  {
    id: 'timeline-2024-01-15',
    date: '2024-01-15',
    category: 'research',
    type: 'achievement',
    title: 'AI 기반 스마트팜 특허 기술이전',
    description: '컴퓨터공학과 박교수 연구팀의 스마트팜 시스템이 농협중앙회에 1.2억원에 기술이전 성공',
    icon: '🏆',
    color: '#16a34a',
    importance: 'high',
  ...
  {
    id: 'timeline-2024-01-10',
    date: '2024-01-10',
    category: 'community',
    type: 'event',
    title: '지역 중소기업 기술지원 플랫폼 구축 확정',
    description: '시민 아이디어 제안이 채택되어 5,000만원 예산으로 3월 출시 예정',
    icon: '🤝',
    color: '#9333ea',
    importance: 'medium',
    budget: 50000000,
  ...
  {
    id: 'timeline-2024-01-05',
    date: '2024-01-05',
    category: 'students',
    type: 'achievement',
    title: '2023년 취업률 78.5% 달성',
    description: '전국 국립대 평균(74.2%) 대비 4.3%p 높은 취업률 기록. 컴퓨터공학과 92.3%로 최고치',
    icon: '🎓',
    color: '#f97316',
    importance: 'high',
    stats: { rate: 78.5, increase: 4.3 },
  },
  {
    id: 'timeline-2023-12-21',
    date: '2023-12-21',
    category: 'transparency',
    type: 'event',
    title: '2023 4분기 타운홀 미팅 개최',
    description: '542명 참여, 2023년 연간 성과 발표 및 2024년 운영 계획 공유. 온라인 조회수 4,820회',
    icon: '🎤',
    color: '#0891b2',
    importance: 'medium',
    participants: 542,
  ...
  {
    id: 'timeline-2023-12-20',
    date: '2023-12-20',
    category: 'community',
    type: 'decision',
    title: '도서관 리모델링 시민투표 확정',
    description: '2,847명 투표 참여로 도서관 리모델링(1.8억원)이 우선 개선 시설로 확정',
    icon: '📚',
    color: '#9333ea',
    importance: 'high',
    votes: 2847,
  ...
  {
    id: 'timeline-2023-12-15',
    date: '2023-12-15',
    category: 'environment',
    type: 'achievement',
    title: '재생에너지 사용률 18.5% 달성',
    description: '태양광 패널 추가 설치로 전년 대비 3.2%p 상승. 2025년 목표 25% 달성 가능',
    icon: '🌱',
    color: '#16a34a',
    importance: 'medium',
    stats: { current: 18.5, increase: 3.2, target: 25 },
  },
  {
    id: 'timeline-2023-12-01',
    date: '2023-12-01',
    category: 'research',
    type: 'achievement',
    title: '친환경 농업 기술 특허 기술이전',
    description: '농생명과학대학 김교수 연구팀의 친환경 농업 기술이 ㈜그린팜에 1.5억원에 기술이전',
    icon: '🔬',
    color: '#16a34a',
    importance: 'high',
    amount: 150000000,
  ...
  {
    id: 'timeline-2023-11-20',
    date: '2023-11-20',
    category: 'students',
    type: 'decision',
    title: 'AI/데이터 분석 평생교육 프로그램 확정',
    description: '시민투표 2,456명 참여로 신규 평생교육 프로그램 분야 결정',
    icon: '💻',
    color: '#f97316',
    importance: 'medium',
    votes: 2456,
  ...
  {
    id: 'timeline-2023-11-01',
    date: '2023-11-01',
    category: 'environment',
    type: 'milestone',
    title: '탄소배출 12.3% 감축 목표 달성',
    description: '에너지 효율화 및 재생에너지 확대로 전년 대비 탄소배출 12.3% 감축 성공',
    icon: '♻️',
    color: '#16a34a',
    importance: 'high',
    stats: { reduction: 12.3 },
  },
  {
    id: 'timeline-2023-10-15',
    date: '2023-10-15',
    category: 'budget',
    type: 'milestone',
    title: '연구비 54억원 유치 달성',
    description: '2023년 외부 연구비 유치 목표 54억원 조기 달성. 전년 대비 18% 증가',
    icon: '💸',
    color: '#2563eb',
    importance: 'high',
    amount: 5400000000,
  ...
  {
    id: 'timeline-2023-09-01',
    date: '2023-09-01',
    category: 'students',
    type: 'event',
    title: '학생 창업 기업 39개 운영 중',
    description: '학생 창업 기업 생존률 83.0%로 전국 평균 초과. 누적 투자 유치 24억원',
    icon: '🚀',
    color: '#f97316',
    importance: 'medium',
    stats: { total: 47, active: 39, survivalRate: 83.0, funding: 2400000000 },
  },
]
